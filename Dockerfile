...
RUN apk add --no-cache \
    ...
    && sed -i 's/browser_executable_path=self.browser_path)/browser_executable_path=self.browser_path, no_sandbox=True)/' /opt/yt-session-generator/potoken_generator/extractor.py \
